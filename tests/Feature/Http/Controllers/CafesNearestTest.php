...
test('fail if location query is invalid', function (string $latitudeQuery, string $latitudeError, string $longitudeQuery, string $longitudeError): void {
    ...
    'latitude is not a number' => ['latitudeQuery' => 'latitude=a', 'latitudeError' => 'The latitude must be a number.'],
    'latitude too small' => ['latitudeQuery' => 'latitude='.random_int(-200, -91), 'latitudeError' => 'The latitude must be between -90 and 90.'],
    'latitude too big' => ['latitudeQuery' => 'latitude='.random_int(91, 200), 'latitudeError' => 'The latitude must be between -90 and 90.'],
])->with([
    ...
    'longitude too is not a number' => ['longitudeQuery' => 'longitude=a', 'longitudeError' => 'The longitude must be a number.'],
    'longitude too small' => ['longitudeQuery' => 'longitude='.random_int(-200, -181), 'longitudeError' => 'The longitude must be between -180 and 180.'],
